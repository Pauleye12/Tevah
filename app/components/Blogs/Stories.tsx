...
const Stories = () => {
  return (
    <div className='py-[150px] pb-[180px] overflow-hidden  font-DMSans  mt-[80px] bg-[#1E1E1E] relative flex flex-col  justify-center items-center "'>
      <div className="w-full max-w-[1200px] px-5  flex justify-start ">
        <h1 className="max-w-[900px] w-full font-DarkerGrotesque text-white text-[40px] leading-[40px] md:text-[56px] md:leading-[56px] font-semibold ">
