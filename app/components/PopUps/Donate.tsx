...
const textVariants: Variants = {
  ...
  exit: { opacity: 0.6, y: 90, transition: { duration: 0.4, ease: "easeOut" } },
};
  ...
  return (
    <div className="bg-[#1e1e1e99] w-full h-screen fixed top-0 left-0 z-50 font-DMSans flex justify-center items-end ">
      ...
      >
        ...
        <div className="rounded-t-[36px] w-full px-5 md:px-[50px] flex flex-col gap-3 py-8 bg-white checkerBg pb-10 md:pb-8 ">
